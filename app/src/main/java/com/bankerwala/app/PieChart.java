...
public class PieChart extends View {
    ...
    private String aboutChartValue;
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            try {
                ...
                aboutChartValue = array.getString(R.styleable.PieChart_aboutChartValue);
                ...
                for (int i = chartData.size() - 1; i >= 0; i--) {
                    ...
                    if (animateValue <= chartUtils.get(i).getRadius()) {
                        ...
                        if (i == chartUtils.size() - 1 && animateValue == chartUtils.get(i).getRadius()) {
                            ...
                            canvas.drawText(chartData.get(i).getDisplayText(), x, y+9, textPaint);
                            //canvas.drawText(chartData.get(i).getDisplayPercent(), x, y+40, textPaint);
                        }
                    } else {
                    ...
                    if (aboutChart != null) {
                        ...
                        canvas.drawText(aboutChartValue, cx, cy+40, textPaint);
                    }
                }
            } else
                animateChart();
    ...
    /**
     *
     * @param aboutChartValue about the chart will display on centre of the chart beneath the aboutChart
     *                   (This should be in single word for better representation)
     */
    public void setAboutChartValue(String aboutChartValue) {
        this.aboutChartValue = aboutChartValue;
    }

    /**
     *
     * @param textSize textsize for chart
     */
